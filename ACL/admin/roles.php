...
<div id="page">
    ...
    if ( isset($_GET['action']) && $_GET['action'] == 'role') { 
        ...
        <form action="roles.php" method="post">
        	<label	for="roleName">Name:</label><input type="text" name="roleName" id="roleName"
        				value="<?php if(isset($_GET['roleID'])){
            ...
            foreach ($aPerms as $k => $v)
            {
                ...
                if ( isset($rPerms[$v['Key']]) && $rPerms[$v['Key']]['value'] === true && $_GET['roleID'] != '') { echo " checked=\"checked\""; }
                echo " /></td>";
        ...
        <input type="hidden" name="roleID"
        			value="<?php if(isset($_GET['roleID'])){ echo $_GET['roleID']; } ?>" />
