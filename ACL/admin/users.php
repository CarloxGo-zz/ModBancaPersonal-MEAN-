	...
	?>
        ...
        <form action="users.php" method="post">
            ...
            foreach ($aPerms as $k => $v)
            {
				...
				echo ">Allow</option>";
				echo "<option value=\"0\"";
				if ( isset($rPerms[$v['Key']]) && $rPerms[$v['Key']]['value'] === false && $rPerms[$v['Key']]['inheritted'] != true) { echo " selected=\"selected\""; }
				echo ">Deny</option>";
				echo "<option value=\"x\"";
				if ( isset($rPerms[$v['Key']]) && $rPerms[$v['Key']]['inheritted'] == true || !array_key_exists($v['Key'],$rPerms))
				{
